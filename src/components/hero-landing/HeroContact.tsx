const HeroContact = () => {
  return (
    <div className="flex flex-col items-start w-full text-lg font-medium leading-6 justify-start">
      <div className="mt-6 text-black w-[648px] max-md:mt-10 tracking-wide">
        Vous avez des questions ?
        <br />
        Contactez-nous !
      </div>
      <div className="mt-4 text-4xl leading-none text-black flex flex-col tracking-wide">
        ...
        <span className="text-sm">
          <i className="text-[#603f32] fa-solid fa-envelope"></i>{" "}
