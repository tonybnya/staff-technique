...
const BenefitsSection = () => {
  return (
    <div className="bg-[#09090b] flex overflow-hidden flex-col items-center px-20 pt-20 pb-28 max-md:px-5 max-md:pb-24">
      <div className="flex flex-col w-full max-w-[1614px] max-md:max-w-full items-center">
        <div className="flex flex-col self-center max-w-full text-center text-white w-[922px]">
          ...
          <div className="self-start mt-9 text-lg font-medium tracking-tight max-md:max-w-full text-gray-400">
